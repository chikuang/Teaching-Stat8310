...
* **B1**: $\be(\neg H|H) \le \be (F \mid H) \le \be(H \mid H)$
...
$$\{\pr(E\mid H1), \pr(E\mid H2),\pr(E\mid H3), \pr(E\mid H4)\} = {.11, .19, .31, .53}.$$
...
$\{\pr(H_1\mid E), \pr(H_2\mid E), \pr(H_3\mid E), \pr(H_4\pr E)\} = {0.09, 0.17, 0.27, 0.47} ,$
and we see that the income distribution for people in the college-educated
population differs markedly from $\{1/4, 1/4,1/4,1/4\}$, the distribution for the
