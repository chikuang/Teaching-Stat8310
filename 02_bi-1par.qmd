...
## The Binomial Model (One-Parameter Models)

We study Bayesian inference for a binomial proportion $\theta$ when the sample size $n$ is fixed.
...
In general, a random variable $\theta \in (0,1)$ follows a Beta$(a,b)$ distribution if
$$
p(\theta)
=
